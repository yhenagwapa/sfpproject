                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="datatable-container">
                                            <table class="table table-borderless datatable datatable-table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" data-sortable="true" style="width: 35.096385542168676%;">
                                                            <button class="datatable-sorter">Province</button></th>
                                ...
                                <div class="datatable-container">
                                    <table class="table table-borderless datatable datatable-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr data-index="0">
                                                <td scope="row" class="text-xs text-gray-400"><a href="#">&nbsp;&nbsp;&nbsp;Male</a></td>
                                                <td class="text-xs text-gray-400">750</td>
                                            </tr>
                                            <tr data-index="0">
                                                <td scope="row" class="text-xs text-gray-400"><a href="#">&nbsp;&nbsp;&nbsp;Female</a></td>
                                                <td class="text-xs text-gray-400">750</td>
                                            </tr>
                                            <tr data-index="0">
