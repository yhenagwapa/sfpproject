                    ...
                    <div class="card-body">
                        ...
                        <form class="row" method="post" action="{{ route('child.update') }}" novalidate>
                            ...
                            @if(auth()->user()->hasRole('lgu focal') || auth()->user()->hasRole('sfp coordinator') || auth()->user()->hasRole('admin'))
                                    ...
                                    <select
                                        ...
                                        @foreach ($centerNames as $center)
                                            <option value="{{ $center->id }}"
                                                {{ $center->id == old('child_development_center_id', $childRecord->child_development_center_id) ? 'selected' : '' }}>
                                                {{ $center->center_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <input type="hidden" name="implementation_id" value="{{ $childCycle }}">
                                <input type="hidden" name="is_funded" value="{{ $childRecord->funded }}" />
                            @endif
