<table id='children-table' class="table datatable mt-3 text-center" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td class="inline-flex items-center justify-center">
                        <div class="flex space-x-3">
                            @can(['edit-child'])
                            <form id="editChild{{ $maleChild->id }}" action="{{ route('child.show') }}" method="POST">
                                @csrf
                                <input type="hidden" name="child_id" value="{{ $maleChild->id }}">

                            <a href="#" class="relative inline-flex items-center justify-center" onclick="document.getElementById('editChild{{ $maleChild->id }}').submit();">
    ...
    <script>
        function saveAndSubmit(child_id) {
            ...
            document.getElementById('child_uid' + child_id).value = child_id;
