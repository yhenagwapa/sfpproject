                ...
                @if (!auth()->user()->hasRole('lgu focal'))
                    <td>
                        <div class="flex space-x-2">
                            @canany(['edit-child'])
                                <a href="{{ route('child.show', $femaleChild->id) }}" class="relative group">
                            ...
                            @can(['nutrition-status-entry'])
                                <a href="{{ route('nutritionalstatus.index', $femaleChild->id) }}" class="relative group">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            @canany('add-attendance')
                                <a href="{{ route('attendance.index', $femaleChild->id) }}" class="relative group">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
