<table id='height-for-age-upon-entry-table' class="table datatable mt-3 text-xs text-center">
    <thead class="border bg-gray-200">
        <tr>
            ...
            <th class="border border-white" colspan="8">Stunted</th>
            <th class="border border-white" colspan="8">Severly Stunted</th>
            <th class="border border-white" colspan="8">Tall</th>
