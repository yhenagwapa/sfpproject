<table id='undernourished-table' class="table datatable mt-3 text-xs text-center" style="min-width: 1800px;">
    <thead class="border bg-gray-200">
        <tr>
            ...
            <th class="border border-white" colspan="3">Total No. Served</th>
            <th class="border border-white" colspan="10">Total No. of CDCCh/SNP Served</th>
            <th class="border border-white" colspan="8"> </th>
        </tr>
        <tr>
