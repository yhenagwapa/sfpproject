                                    ...
                                    @if (auth()->user()->hasRole('admin') ||
                                        ...
                                        <li class="nav-item">
                                            <form id="unfundedForm" action="{{ route('reports.unfunded', ['cycle' => $cycle->id])}}" method="POST">
                                                @csrf
                                                <a class="report-link collapsed active" href="#" onclick="document.getElementById('unfundedForm').submit(); return false;">
                                                    <svg class="h-2 w-2 mr-2" width="24" height="24"
                                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" />
                                ...
                                <div id="report-content">
                                    @if (auth()->user()->hasRole('admin') ||
                                        ...
                                        <div id="funded-content">
                                                <h5 class="card-title">Unfunded Children</h5>

                                                <div class="row">
                                                    <div class="col-md-6 mt-2 text-sm">
                                                        <form action="{{ route('reports.unfunded', ['cycle' => $cycle->id]) }}" method="POST" id="filterForm">
                                                            @csrf
                                                ...
                                                <script>
                                                    document.getElementById('center_name').addEventListener('change', function() {
                                                        ...
                                                        printButton.href = '/reports/{cycle}/print/unfunded?center_name=' + selectedCenterId;
                                                    });
