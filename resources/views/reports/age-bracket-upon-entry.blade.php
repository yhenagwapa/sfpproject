                                            ...
                                            <ul id="forms-nav" class="report-content collapsed">
                                                    <li>
                                                        <form id="AgeBracketUponEntryForm" action="{{ route('reports.age-bracket-upon-entry', ['cycle' => $cycle->id])}}" method="POST">
                                                            @csrf
                                                            <a class="report-link collapsed active" href="#" onclick="document.getElementById('AgeBracketUponEntryForm').submit(); return false;">
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 size-3">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                                                                </svg>
                                                                Upon Entry
                                ...
                                <div id="report-content">
                                    @if (auth()->user()->hasRole('admin') ||
                                        ...
                                        <div id="funded-content">
                                            <h5 class="card-title">CONSOLIDATED NUTRITIONAL STATUS REPORT PER AGE BRACKET</h5>
                                            <h6 class="card-subtitle">Upon Entry</h6>

                                            <div class="row">
                                                <div class="col-md-6 mt-2 text-sm">
                                                    <form action="{{ route('reports.age-bracket-upon-entry', ['cycle' => $cycle->id]) }}" method="POST" id="filterForm">
                                                        @csrf
                                            ...
                                            <script>
                                                document.getElementById('center_name').addEventListener('change', function() {
                                                    ...
                                                    printButton.href = '/reports/{cycle}/print/age-bracket-upon-entry?center_name=' + selectedCenterId;
                                                });
                                            ...
                                            <div class="table-responsive" style="overflow-x: auto; max-width: 100%;">
                                                @include('reports.partials.upon-entry-age-bracket-table', [
