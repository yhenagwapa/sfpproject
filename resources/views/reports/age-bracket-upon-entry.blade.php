                                        ...
                                        <div id="funded-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mt-2 text-sm">
                                                    <form action="{{ route('reports.age-bracket-upon-entry') }}" method="POST" id="filterForm">
                                                        @csrf
                                            ...
                                            <script>
                                                document.getElementById('center_name').addEventListener('change', function() {
                                                    ...
                                                    printButton.href = '/reports/print/age-bracket-upon-entry?center_name=' + selectedCenterId;
                                                });
