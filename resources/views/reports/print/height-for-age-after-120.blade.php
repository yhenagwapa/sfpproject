...
<head>
    <style>
        ...
        .height-for-age-after-120-table {
            font-size: 10px;
            font-family: 'Arial', sans-serif;
            text-align: center;
...
<body>
    ...
    <div class="header">
        <p>Department of Social Welfare and Development, Field Office XI<br>
            ...
            {{ $cycle->name }} ( CY {{ $cycle->school_year }} )<br>
            <b>CONSOLIDATED NUTRITIONAL STATUS REPORT</b><br>
            <i>(Height-for-Age)<br>Upon Entry</i></p>
        <br>
    </div>
    ...
    <table id='height-for-age-after-120-table' class="table datatable height-for-age-after-120-table w-full">
        ...
        <tbody class="height-for-age-after-120-table text-xs">
            ...
            @php
                ...
                $allStuntedeFemale =
                    $stuntedAged2Female + $stuntedAged3Female + $stuntedAged4Female + $stuntedAged5Female;
