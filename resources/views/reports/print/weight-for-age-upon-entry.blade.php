        ...
        <table id='weight-for-age-upon-entry-table' class="table datatable weight-for-age-upon-entry-table w-full">
            <thead>
                <tr>
                    ...
                    <th class="border-bg" rowspan="3">Name of Child Development Worker<br><i>(Surname, First name, M.
                            I.)</i></th>
            ...
            <tbody class="weight-for-age-upon-entry-table">
                ...
                @foreach ($chunk as $center)
                    @php
                        ...
                        $normalAged2Male +=
                            $ageGroupsPerCenter[$center->id]['2']['weight_for_age']['normal']['male'] ?? 0;
                        $normalAged3Male +=
                            $ageGroupsPerCenter[$center->id]['3']['weight_for_age']['normal']['male'] ?? 0;
                        $normalAged4Male +=
                            $ageGroupsPerCenter[$center->id]['4']['weight_for_age']['normal']['male'] ?? 0;
                        $normalAged5Male +=
                            $ageGroupsPerCenter[$center->id]['5']['weight_for_age']['normal']['male'] ?? 0;
                        ...
                        $severelyUnderweightAged2Male +=
                            $ageGroupsPerCenter[$center->id]['2']['weight_for_age']['severely_underweight']['male'] ??
                            0;
                        $severelyUnderweightAged3Male +=
                            $ageGroupsPerCenter[$center->id]['3']['weight_for_age']['severely_underweight']['male'] ??
                            0;
                        $severelyUnderweightAged4Male +=
                            $ageGroupsPerCenter[$center->id]['4']['weight_for_age']['severely_underweight']['male'] ??
                            0;
                        $severelyUnderweightAged5Male +=
                            $ageGroupsPerCenter[$center->id]['5']['weight_for_age']['severely_underweight']['male'] ??
                            0;

                        $severelyUnderweightAged2Female +=
                            $ageGroupsPerCenter[$center->id]['2']['weight_for_age']['severely_underweight']['female'] ??
                            0;
                        $severelyUnderweightAged3Female +=
                            $ageGroupsPerCenter[$center->id]['3']['weight_for_age']['severely_underweight']['female'] ??
                            0;
                        $severelyUnderweightAged4Female +=
                            $ageGroupsPerCenter[$center->id]['4']['weight_for_age']['severely_underweight']['female'] ??
                            0;
                        $severelyUnderweightAged5Female +=
                            $ageGroupsPerCenter[$center->id]['5']['weight_for_age']['severely_underweight']['female'] ??
                            0;
                    ...
                    <tr>
                        ...
                        <td>{{ $ageGroupsPerCenter[$center->id]['2']['weight_for_age']['underweight']['male'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['3']['weight_for_age']['underweight']['male'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['4']['weight_for_age']['underweight']['male'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['5']['weight_for_age']['underweight']['male'] ?? 0 }}
                        </td>
                        ...
                        <td>{{ $ageGroupsPerCenter[$center->id]['2']['weight_for_age']['overweight']['male'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['3']['weight_for_age']['overweight']['male'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['4']['weight_for_age']['overweight']['male'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['5']['weight_for_age']['overweight']['male'] ?? 0 }}
                        </td>

                        <td>{{ $ageGroupsPerCenter[$center->id]['2']['weight_for_age']['overweight']['female'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['3']['weight_for_age']['overweight']['female'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['4']['weight_for_age']['overweight']['female'] ?? 0 }}
                        </td>
                        <td>{{ $ageGroupsPerCenter[$center->id]['5']['weight_for_age']['overweight']['female'] ?? 0 }}
                        </td>
    ...
    <tfoot>
        ...
        @php
            ...
            $allUnderweighteFemale =
                $underweightAged2Female + $underweightAged3Female + $underweightAged4Female + $underweightAged5Female;
