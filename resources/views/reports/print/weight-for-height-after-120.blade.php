...
<head>
    <style>
        ...
        .weight-for-height-after-120-table {
            font-size: 10px;
            font-family: 'Arial', sans-serif;
            text-align: center;
        ...
        .weight-for-height-after-120-table th,
        .weight-for-height-after-120-table td {
...
<body>
    ...
    <div class="header">
        <p>Department of Social Welfare and Development, Field Office XI<br>
            ...
            <i>(Weight-for-Height)<br>After 120 Feeding Days</i></p>
        <br>
    </div>
    ...
    <table id='weight-for-height-after-120-table' class="table datatable weight-for-height-after-120-table w-full">
