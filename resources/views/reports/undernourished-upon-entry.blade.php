                                            ...
                                            <ul id="forms-nav" class="report-content collapsed">
                                                <li class="nav-item">
                                                    <form id="undernourishedUponEntryForm" action="{{ route('reports.undernourished-upon-entry', ['cycle' => $cycle->id])}}" method="POST">
                                                        @csrf
                                                        <a class="report-link collapsed active" href="#" onclick="document.getElementById('undernourishedUponEntryForm').submit(); return false;">
                                        ...
                                        <div id="funded-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mt-2">
                                                        <a href="{{ url('/reports/{cycle}/print/undernourished-upon-entry') }}" target="_blank" id="printButton">
