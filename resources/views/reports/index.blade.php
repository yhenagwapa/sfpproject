                                                        ...
                                                        <ul class="d-flex list-unstyled">
                                                            <li class="nav-item dropdown pe-3" x-data="{ open: false }">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                                                                    <li>
                                                                        <button class="dropdown-item d-flex align-items-center" onclick="workerReport('masterlist'); return false;">
                                                                    ...
                                                                    <li>
                                                                        <button class="dropdown-item d-flex align-items-center ml-3"
