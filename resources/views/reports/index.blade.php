                                ...
                                <div id="funded-content">
                                                                ...
                                                                <form id="printCDWForm" action="" method="POST">
                                                                    ...
                                                                    <li>
                                                                        <button
                                                                            ...
                                                                            <span>Generate After 120 Feedings</span>
                                                                        </button>
                                                                    </li>
                                                                    <li>
                                                                        <hr class="border-t my-1">
                                                                    ...
                                                                    @if (auth()->user()->hasRole('admin') || auth()->user()->hasRole('lgu focal'))
                                                                        <li>
                                                                            <button
                                                                                ...
                                                                                <span>Generate Malnourished Children</span>
                                                                            </button>
                                                                        </li>
                                                                        <li>
                                                                            <hr class="border-t my-1">
                                                                        ...
                                                                        <li>
                                                                            <button
                                                                                ...
                                                                                <span>Generate Weight for Age</span>
                                                                            </button>
                                                                        </li>
                                                                        <li>
                                                                            <button
                                                                                ...
                                                                                <span>Generate Height for Age</span>
                                                                            </button>
                                                                        </li>
                                                                        <li>
                                                                            <button
                                                                                ...
                                                                                <span>Generate Weight for Height</span>
                                                                            </button>
                                                                        </li>
                                                                        <li class="hidden">
                                                                            <hr class="border-t my-1">
                                    ...
                                    <script>
                                        function workerReport(reportType) {
                                            ...
                                            printCDWForm.action = `{{ url('') }}/reports/generate-${reportType}`;
                                            // printCDWForm.target = "_blank";
                                            printCDWForm.submit();
                                        }

                                        // Get the select element and the hidden input
                                        const centerSelect = document.getElementById('center_name');
                                        const hiddenCenterInput = document.getElementById('center_id');

                                        // Set initial value on page load
                                        hiddenCenterInput.value = centerSelect.value;

                                        // Listen for changes
                                        centerSelect.addEventListener('change', function() {
                                            hiddenCenterInput.value = this.value;
