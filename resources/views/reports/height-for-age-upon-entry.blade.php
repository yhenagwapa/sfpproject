                                                    ...
                                                    <ul id="forms-nav" class="report-subcontent collapsed">
                                                        <li>
                                                            <form id="HFAUponEntryForm" action="{{ route('reports.height-for-age-upon-entry', ['cycle' => $cycle->id])}}" method="POST">
                                                                @csrf
                                                                <a class="report-link collapsed active" href="#" onclick="document.getElementById('HFAUponEntryForm').submit(); return false;">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 size-3">
                                                                        <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                                                                    </svg>
                                                                    Upon Entry
                                ...
                                <div id="report-content">
                                    @if (auth()->user()->hasRole('admin') ||
                                        ...
                                        <div id="funded-content">
                                            ...
                                            <h6 class="card-subtitle">Height for Age<br>Upon Entry</h6>

                                            <div class="row">
                                                <div class="col-md-6 mt-2">
                                                    <a href="{{ url('/reports/{cycle}/print/height-for-age-upon-entry') }}" target="_blank" id="printButton">
                                            ...
                                            <div class="table-responsive" style="overflow-x: auto; max-width: 100%;">
                                                @include('reports.partials.height-for-age-upon-entry-table')
                                            </div>
                                            {{-- <div class="mt-3">
