                                ...
                                <div id="report-content">
                                    @if (auth()->user()->hasRole('admin') ||
                                        ...
                                        <div id="funded-content">
                                            ...
                                            <h6 class="card-subtitle">Weight for Age<br>After 120 Feeding Days</h6>

                                            <div class="row">
                                                <div class="col-md-6 mt-2">
                                                    <a href="{{ url('/reports/{cycle}/print/weight-for-age-after-120') }}" target="_blank" id="printButton">
                                            ...
                                            <div class="table-responsive" style="overflow-x: auto; max-width: 100%;">
                                                @include('reports.partials.weight-for-age-after-120-table')
                                            </div>
                                            {{-- <div class="mt-3">
