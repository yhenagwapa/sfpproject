                                    ...
                                    @if (auth()->user()->hasRole('admin') ||
                                        ...
                                        <li class="nav-item">
                                            <form id="monitoringForm" action="{{ route('reports.monitoring', ['cycle' => $cycle->id])}}" method="POST">
                                                @csrf
                                                <a class="report-link collapsed active" href="#" onclick="document.getElementById('monitoringForm').submit(); return false;">
                                ...
                                <div id="report-content">
                                    @if (auth()->user()->hasRole('admin') ||
                                        ...
                                        <div id="funded-content">
                                                <h5 class="card-title">Weight and Height Monitoring</h5>

                                                <div class="row">
                                                    <div class="col-md-6 mt-2 text-sm">
                                                        <form action="{{ route('reports.monitoring', ['cycle' => $cycle->id]) }}" method="POST" id="filterForm">
                                                            @csrf
                                                ...
                                                <script>
                                                    document.getElementById('center_name').addEventListener('change', function() {
                                                        ...
                                                        printButton.href = '/reports/{cycle}/print/monitoring?center_name=' + selectedCenterId;
                                                    });
