...
<body>
    ...
    <table id='funded-table' class="table datatable funded-table border border-black w-full">
        <thead class="border border-black">
            <tr>
                <th class="border-2 border-black" rowspan="2">Name of Child</th>
                <th class="border-2 border-black" rowspan="2">Sex</th>
                <th class="border-2 border-black" rowspan="2">Date of Birth</th>
                <th class="border-2 border-black" rowspan="2">Actual Date of Weighing</th>
                <th class="border-2 border-black" rowspan="2">Weight in kg.</th>
                <th class="border-2 border-black" rowspan="2">Height in cm.</th>
                <th class="border-2 border-black" colspan="2">Age in month/year</th>
                <th class="border-2 border-black" colspan="3">Nutritional Status</th>
                <th class="border-2 border-black" rowspan="2">Summary of Undernourished Children</th>
                <th class="border-2 border-black" rowspan="2">Deworming</th>
                <th class="border-2 border-black" rowspan="2">Vitamin A</th>
                <th class="border-2 border-black" rowspan="2">Pantawid Member</th>
                <th class="border-2 border-black" rowspan="2">IPs</th>
                <th class="border-2 border-black" rowspan="2">PWD</th>
                <th class="border-2 border-black" rowspan="2">Child of Solo Parent</th>
                <th class="border-2 border-black" rowspan="2">Lactose Intolerant</th>
            </tr>
            <tr>
                <th class="border-2 border-black">Month</th>
                <th class="border-2 border-black">Year</th>
                <th class="border-2 border-black">Weight for Age</th>
                <th class="border-2 border-black">Weight for Height</th>
                <th class="border-2 border-black">Height for Age</th>
            </tr>
        </thead>
        <tbody class="funded-table">
            @foreach ($isFunded as $fundedChild)
                <tr>
                    <td class="border border-black">{{ $fundedChild->full_name }}</td>
