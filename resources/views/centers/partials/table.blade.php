                ...
                <td class="inline-flex items-center justify-center">
                    <div class="flex space-x-3">
                        @can(['edit-child-development-center'])
                            ...
                            {{-- <a href="{{ route('centers.edit') }}" class="relative inline-flex items-center justify-center">
                            ...
                            <form id="center_id-{{ $center['center_id'] }}" action="{{ route('centers.edit') }}" method="POST" class="inline">
                                @csrf
