...
class ProcessPendingNsHfaReportsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reports:process-pending-ns-hfa';
     ...
     * @var string
     */
    protected $description = 'Process all pending NS Height-for-Age reports and generate PDFs';
    ...
    {
        $pendingReports = DB::table('ns_hfa_reports')
        ...
        foreach ($pendingReports as $report) {
            try {
                ...
                $filePath = NutritionalStatusHFAReportGeneration::generatePDF($report->user_id);
