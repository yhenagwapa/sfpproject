...
class ProcessPendingNsWfaReportsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reports:process-pending-ns-wfa';
     ...
     * @var string
     */
    protected $description = 'Process all pending NS Weight-for-Age reports and generate PDFs';
    ...
    {
        $pendingReports = DB::table('ns_wfa_reports')
        ...
        foreach ($pendingReports as $report) {
            try {
                ...
                $filePath = NutritionalStatusWFAReportGeneration::generatePDF($report->user_id);
