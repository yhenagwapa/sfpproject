...
class ProcessPendingDisabilityReportsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reports:process-pending-disabilities';
     ...
     * @var string
     */
    protected $description = 'Process all pending disability reports and generate PDFs';
    ...
    public function handle()
    {
        ...
        $pendingReports = DB::table('disability_reports')
        ...
        foreach ($pendingReports as $report) {
            try {
                ...
                $filePath = DisabilityReportGeneration::generatePDF($report->user_id);
