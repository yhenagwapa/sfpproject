...
use App\Models\ExitNutritionalStatus;
use App\Http\Requests\StoreExitNutritionalStatusRequest;
use App\Http\Requests\UpdateExitNutritionalStatusRequest;
use Illuminate\Support\Facades\DB;
use App\Models\Child;
use Carbon\Carbon;

class ExitNutritionalStatusController extends Controller
{
    public function __construct()
    {
        $this->middleware('auth');
        $this->middleware('permission:nutrition-status-exit', ['only' => ['index', 'store']]);
        $this->middleware('permission:nutrition-status-exit', ['only' => ['store']]);
    }
    /**
     ...
     */
    public function store(StoreExitNutritionalStatusRequest $request)
    {

        $validatedData = $request->validated();

        $existingRecord = ExitNutritionalStatus::where('child_id', $request->child_id)
                        ->first();
        ...
        $entryNutritionalStatus = ExitNutritionalStatus::create([
     ...
     */
    public function show(ExitNutritionalStatus $exitNutritionalStatus)
    {
        //
    }
     ...
     */
    public function edit(ExitNutritionalStatus $exitNutritionalStatus)
    {
        //
    }
     ...
     */
    public function update(UpdateExitNutritionalStatusRequest $request, ExitNutritionalStatus $exitNutritionalStatus)
    {
        //
    }
     ...
     */
    public function destroy(ExitNutritionalStatus $exitNutritionalStatus)
    {
        //
    }
}
