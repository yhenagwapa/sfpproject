...
return new class extends Migration
{
    ...
    {
        Schema::create('undernourished_after_120_reports', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('undernourished_after_120_report_data', function (Blueprint $table) {
            $table->id();
            $table->foreignId('report_id')->constrained('undernourished_after_120_reports')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('undernourished_after_120_report_data');
        Schema::dropIfExists('undernourished_after_120_reports');
    }
};
